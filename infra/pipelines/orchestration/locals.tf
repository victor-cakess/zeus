locals {
  ...
  ingest_sources = [
    ...
    },
    {
      ...
      function_arn = data.terraform_remote_state.eia_interchange.outputs.ingest_function_arn
      units        = data.terraform_remote_state.eia_interchange.outputs.balancing_authorities
    },
    {
      name         = "noaa"
