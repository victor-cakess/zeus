"""Phase B: per day, consolidate that day's raw JSON files (all series) into one
...
Days with no raw data (weekends/holidays — every FRED series is business-day or
sparser) write nothing.
"""
