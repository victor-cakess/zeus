...
-- LEFT to NOAA weather. Grain: one row per (ba, date) — row existence tracks
-- generation (DECISIONS.md M-4): all 71 BAs appear; weather columns are null for
-- uncovered BAs and inside NOAA's ~3-day publication lag.
--
