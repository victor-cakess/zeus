...
# upper-case NOAA_GRID columns. DATA_TYPES is the single source of truth for the set:
# client.py builds the request param from it, SCHEMA and normalize_row derive from it,
# and infra/core/snowflake_noaa.tf mirrors it. NCEI omits types a station didn't
# report, so they land null.
DATA_TYPES = [
    "TMAX", "TMIN", "TAVG",
    "PRCP", "SNOW", "SNWD",
    "AWND", "WSF2", "WSF5", "WDF2",
...
SCHEMA = pa.schema(
    ...
    + [pa.field(dt.lower(), pa.float64()) for dt in DATA_TYPES]
